...
public class Toets3 extends Applet {
	Button knop1;
	Button knop2; 
	Button knop3;
	Button knop4;
	...
	Button knop6;
	Button knop7;
	double bedrag, teller = 1, bestellingswaarde, dagomzet, gemiddelde;
	...
	public void paint(Graphics g) {
		...
		g.drawString("Totaal dagomzet: " + String.format("%.2f", gemiddelde), 50, 140 );
	}
...
//Opmerking: krijg niet voor elkaar de teller op te lossen en het gemiddelde is per stuk ofzo...