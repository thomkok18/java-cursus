...
public class Toets2 extends Applet {
    ...
    Button knop6;
    Button knop7;
    double bedrag, teller = 0, bestellingswaarde, dagomzet, gemiddelde;
    ...
    public void paint(Graphics g) {
        ...
        g.drawString("Gemiddelde dagomzet: " + String.format("%.2f", gemiddelde), 50, 140 );
    }
    ...
    class knop7Listener implements ActionListener	{
        public void actionPerformed( ActionEvent e ) {
            ...
            gemiddelde = (gemiddelde + bestellingswaarde) / 2;
            bestellingswaarde = 0;
            teller = 0;
            repaint();
        }
